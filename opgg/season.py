...
class RankEntry:
    ...
    def __init__(self, game_type: str, rank_info: Tier, created_at: datetime):
...
class Season:
    ...
    def __init__(self, season_id: int, tier_info: Tier, rank_entries: list[RankEntry], created_at: datetime):
...
class SeasonInfo:
    ...
    def __init__(self, id: int, value: int, display_value: int, split: int, is_preseason: bool):
        self._id = id
        self._value = value
