...
class Tier:
    ...
    def __init__(
        ...
        self._tier = tier if tier is not None else "UNRANKED"
        self._division = division if division is not None else 0
        self._lp = lp if lp is not None else 0
    ...
    def tier_image_url(self, value: str):
    ...
    def border_image_url(self, value: str):
...
class QueueInfo:
    ...
    def __init__(self, id: int, queue_translate: str, game_type: str):
        self._id = id
    ...
    def queue_translate(self, value: str):
...
class LeagueStats:
    ...
    def __init__(
        ...
        self._win = win if win is not None else 0
        self._lose = lose if lose is not None else 0
    ...
    @queue_info.setter
    def queue_info(self, value: QueueInfo):
    ...
    def is_hot_streak(self, value: bool):
    ...
    def is_fresh_blood(self, value: bool):
    ...
    @is_veteran.setter
    def is_veteran(self, value: bool):
    ...
    @is_inactive.setter
    def is_inactive(self, value: bool):
